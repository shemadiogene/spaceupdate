        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Our Amazing spaces for lend</h1>
          ...
          <div class="col-sm-12">
            <div class="grid-option">
              ...
              <?php
                ...
                $limits = 15;
                $start = (($page-1)*$limits);
                    $query = mysqli_query($conn,"SELECT *FROM companies,offices WHERE offices.saleStatus='reserve' AND companies.coStatus='Approved' AND offices.companyId=companies.id ORDER BY offices.id DESC limit $start,$limits") or die(mysqli_error($conn));
                      $size = mysqli_query($conn,"SELECT *FROM companies,offices WHERE offices.saleStatus='reserve' AND companies.coStatus='Approved' AND offices.companyId=companies.id ORDER BY offices.id DESC") or die(mysqli_error($conn));
                                ...
                                <div class="card-overlay-a-content">
                                  ...
                                  <div class="card-body-a">
                                    <div class="price-box d-flex">
                                      <small class="price-a"><?= $rows['status'];?> |  <?= $rows['price'];?> Rwf</small>
                                    </div>
