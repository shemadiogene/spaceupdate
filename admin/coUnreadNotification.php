                ...
                <div class="card">
                    <div class="boxs mail_listing">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php
                                    $q = mysqli_query($conn,"SELECT *FROM conotification WHERE companyId='{$_SESSION['spacecompanies']}' AND status='unread' ORDER BY id DESC limit 20") or die(mysqli_error($conn));
...
<script>
    $(function(){
        ...
        $("#notificationNav1").addClass('active');
    });
</script>
