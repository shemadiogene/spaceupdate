                ...
                <div class="card">
                    <div class="boxs mail_listing">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php
                                    $q = mysqli_query($conn,"SELECT *FROM adminnotification WHERE status='read' ORDER BY id DESC limit 20") or die(mysqli_error($conn));
                                        ...
                                        while ($fe = mysqli_fetch_array($q)) {
                                           ?>
                                            <tr>
                                                ...
                                                <td class="hidden-xs"><a href="?id=<?= $fe['id']?>"><?= substr($fe['content'],0,15)."....";?></a></td>
                                                <td class="max-texts">
                                                <a href="?id=<?= $fe['id']?>"><?= $fe['notTime']?></a>
                                                </td>
                                                <!-- <td class="hidden-xs">
...
<script>
  $(function(){
      ...
      $("#navNotificationAll").addClass('active');
  });
</script>