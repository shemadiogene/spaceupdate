                      ...
                      <ul class="" id="mail-folders">
                        <li>
                          <a href="" title="Inbox">Contact Messages &nbsp;
                              <?php
                                $fi = mysqli_query($conn,"SELECT *FROM contacts WHERE status1='unread'") or die(mysqli_error($conn));
                ...
                <div class="card">
                    <div class="boxs mail_listing">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php
                                    $q = mysqli_query($conn,"SELECT *FROM contacts WHERE status1='unread' ORDER BY id DESC") or die(mysqli_error($conn));
                                        ...
                                        while ($fe = mysqli_fetch_array($q)) {
                                           ?>
                                            <tr>
                                                ...
                                                <td class="hidden-xs"><a href="readMessages?id=<?= $fe['id']?>"><?= $fe['fullnames']?></a></td>
                                                <td class="max-texts">
                                                <a href="readMessages?id=<?= $fe['id']?>"><?= substr($fe['subjects'],0,20)."...";?></a>
                                                </td>
                                                <!-- <td class="hidden-xs">
                                                <i class="material-icons">attach_file</i>
                                                </td> -->
                                                <td class="text-right"> <?= $fe['sentAt'];?> </td>
                                            </tr>
                                           <?php
                                        $count++;}
                                    }
...
<script>
  $(function(){
      ...
      $("#unreadMessage1").addClass('active');
  });
</script>