          ...
          <div class="section-body">
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                <div class="card">
                <?php 
                    $query = mysqli_query($conn,"SELECT *FROM contacts WHERE id='$id'") or die(mysqli_error($conn));
                    if (mysqli_num_rows($query)>0) {
                        $update = mysqli_query($conn,"UPDATE contacts SET status1='read' WHERE id ='$id'") or die(mysqli_error($conn));
                                    ...
                                    <div class="inbox-body no-pad">
                                        ...
                                        <div class="mail-sender">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <small class="text-muted">From: <?= $con['emails']?></small>
                                            </div>
                                            </div>
                                        </div>
