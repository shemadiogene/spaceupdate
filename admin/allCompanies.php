              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                        ...
                        <tbody>
                        <?php
                            $query = mysqli_query($conn,"SELECT *FROM companies WHERE coStatus = 'Approved' ORDER BY id DESC") or die(mysqli_error($conn));
                                ...
                                while ($rows = mysqli_fetch_array($query)) {
                                   ?>
                                        <tr>
                                            ...
                                            <td><button onClick="deleteCompany('<?= $rows['id'];?>','<?= $rows['comName'];?>')" id="deleteCom" style="color:white;" class="btn btn-flat btn-danger btn-sm">Delete</button></td>
                                        </tr>
                                   <?php
                                $counter++;}
                            }
