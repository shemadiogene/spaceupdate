                      ...
                      <ul class="" id="mail-folders">
                        <li>
                          <a href="" title="Inbox">Contact Messages &nbsp;
                              <?php
                                $fi = mysqli_query($conn,"SELECT *FROM adminnotification WHERE status='unread'") or die(mysqli_error($conn));
                ...
                <div class="card">
                    <div class="boxs mail_listing">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php
                                    $q = mysqli_query($conn,"SELECT *FROM adminnotification WHERE status='unread' ORDER BY id DESC limit 20") or die(mysqli_error($conn));
                                        ...
                                        while ($fe = mysqli_fetch_array($q)) {
                                           ?>
                                            <tr>
                                                ...
                                                <td class="hidden-xs"><a href="updateAdminNotification?id=<?= $fe['id']?>"><?= substr($fe['content'],0,15)."....";?></a></td>
                                                <td class="max-texts">
                                                <a href="updateAdminNotification?id=<?= $fe['id']?>"><?= $fe['notTime']?></a>
                                                </td>
                                                <!-- <td class="hidden-xs">
