                ...
                <div class="card">
                    <div class="boxs mail_listing">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php
                                    $q = mysqli_query($conn,"SELECT *FROM contactco WHERE companyId='{$_SESSION['spacecompanies']}' ORDER BY id DESC") or die(mysqli_error($conn));
                                        ...
                                        while ($fe = mysqli_fetch_array($q)) {
                                           ?>
                                            <tr>
                                                ...
                                                <td class="max-texts">
                                                <a href="coReadMessage?id=<?= $fe['id']?>"><?= substr($fe['content'],0,15)."...";?></a>
                                                </td>
                                                <!-- <td class="hidden-xs">
