                    ...
                    <form method="POST" enctype="multipart/form-data">
                      <div class="row">
                        ...
                        <div class="form-group col-6">
                          <input id="names" type="text" class="form-control" name="offName" placeholder="Name" autofocus>
                        </div>
                        <div class="form-group col-6">
                          <input id="locations" type="text" class="form-control" placeholder="Location" name="offLocation">
                        </div>
                      </div>

                      <div class="row">
                        <div class="form-group col-6">
                          <input id="phoneNumber" type="number" class="form-control" name="offPhoneNumber" placeholder="Phone Number" autofocus>
                        </div>
                        <div class="form-group col-6">
                          <input id="price" type="number" class="form-control" placeholder="Price" name="offPrices">
                        </div>
                      </div>
                      
                      <div class="row">
                        <div class="form-group col-6">
                          <input id="rooms" type="number" class="form-control" placeholder="Number of spaces" name="offRooms" autofocus>
                        </div>
                        <div class="form-group col-6">
                            <div class="input-group">
                                <input type="number" name="offArea" class="form-control text-left" id="inlineFormInputGroup2" placeholder="Area">
                      ...
                      <div class="row">
                        <div class="form-group col-6">
                          <select required name="offStatus" id="status" class="custom-select">
                      ...
                      <div class="row">
                        <div class="form-group col-6">
                            <div class="custom-file">
                                <input type="file" name="img1" required class="custom-file-input" id="customFile">
                                <label class="custom-file-label" for="customFile">Choose image 1</label>
                            </div>
                        </div>
                        <div class="form-group col-6">
                            <div class="custom-file">
                                <input type="file" name="img2" required class="custom-file-input" id="customFile">
                      ...
                      <div class="row">
                        <div class="form-group col-6">
                            <div class="custom-file">
                                <input type="file" name="img3" required class="custom-file-input" id="customFile">
