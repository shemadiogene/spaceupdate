                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                        ...
                        <?php
                            ...
                            AND customers.companyId=offices.companyId AND offices.id = customers.offId AND offices.status='Sales' AND reserveStatus='Pending' ORDER BY customers.id DESC") or die(mysqli_error($conn));
                                ...
                                while ($rows = mysqli_fetch_array($query)) {
                                   ?>
                                        <tr>
                                            ...
                                            <td><?= $rows['checkout'];?></td>
                                            <?php
                                              if ($rows['reserveStatus'] == 'Pending') {
                                                ?>
                                                  <td><button onClick="updateResStatus('<?= $rows['reserveId']?>')" style="color:white;" class="btn btn-flat btn-info btn-sm">Approve</button></td>
                                                <?php
                                              }else{
                                                ?>
