              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                        ...
                        <?php
                            $id = 
                            $query = mysqli_query($conn,"SELECT *FROM customers,offices WHERE customers.companyId='{$_SESSION['spacecompanies']}' AND customers.reserveStatus='SUCCESS' 
                                ...
                                while ($rows = mysqli_fetch_array($query)) {
                                   ?>
                                        <tr>
                                            ...
                                            <td><?= $rows['checkin'];?></td>
                                            <td><?= $rows['checkout'];?></td>
                                            <td><label class="text-success"><?= $rows['reserveStatus']?></label></td>
                                            <td>
                                            <button onClick="removeBooking('<?= $rows['reserveId']?>')" style="color:white;" class="btn btn-flat btn-danger btn-sm">Cancel</button>
                                            </td>
