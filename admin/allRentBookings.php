              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                        ...
                        <?php
                            $id = 
                            $query = mysqli_query($conn,"SELECT *FROM customers,offices WHERE customers.companyId=offices.companyId AND offices.id = customers.offId AND offices.status='Rent'") or die(mysqli_error($conn));
