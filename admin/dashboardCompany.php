    ...
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-content">
        <section class="section">
          ...
          <?php
              $qs = mysqli_query($conn,"SELECT *FROM customers,companies WHERE customers.reserveStatus = 'SUCCESS' AND companies.id=customers.companyId AND companies.id = {$_SESSION['spacecompanies']}");
                    ...
                    <div class="align-items-center justify-content-between">
                      <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                          <div class="card-content">
                            <?php
                              $fd = mysqli_query($conn,"SELECT *FROM customers,companies WHERE companies.id=customers.companyId AND companies.id = {$_SESSION['spacecompanies']}");
                      ...
                      <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                          <div class="card-content">
                            ...
                            <?php 
                             $spa = mysqli_query($conn, "SELECT COUNT(id) as totaloffices FROM offices WHERE companyId= {$_SESSION['spacecompanies']}") or die(mysqli_error($conn));
                      ...
                      <div class="row ">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                          <div class="card-content">
                            ...
                            <?php
                              $findRev = mysqli_query($conn,"SELECT SUM(offices.price) as summation FROM offices,customers,companies WHERE offices.id = customers.offId AND offices.companyId=companies.id AND `reserveStatus` = 'SUCCESS' AND companies.id= {$_SESSION['spacecompanies']}") or die(mysqli_error($conn));
                              $rev = mysqli_fetch_array($findRev);
                            ?>
                            <h2 class="mb-3 font-18"> <?= $rev['summation'] == '' ? '0': $rev['summation']; ?> Rwf</h2>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                        ...
                        <?php
                            $id = 
                            $query = mysqli_query($conn,"SELECT *FROM offices WHERE companyId = '{$_SESSION['spacecompanies']}' ORDER BY id DESC") or die(mysqli_error($conn));
