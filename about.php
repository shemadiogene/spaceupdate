  ...
  <main id="main">
          ...
          <div class="col-md-12 section-t8">
            <div class="row">
              <div class="col-md-6 col-lg-5">
                <img src="assets/img/avatar-JohnDoe.jpg" alt="" class="img-fluid">
              </div>
              <div class="col-lg-2  d-none d-lg-block">
                <div class="title-vertical d-flex justify-content-start">
                  <!-- <span>SpaceCompany Exclusive Property</span> -->
                </div>
              </div>
              <div class="col-md-6 col-lg-5 section-md-t3">
                <div class="title-box-d">
                  <h3 class="title-d">Manager
    ...
    <section class="section-agents section-t8">
      <div class="container">
        ...
        <div class="row">
          <?php 
            $ss = mysqli_query($conn,"SELECT *FROM users") or die(mysqli_error($conn));
            while ($users = mysqli_fetch_array($ss)) {
              ?>
                <div class="col-md-4">
                  <div class="card-box-d">
                    <div class="card-img-d">
                      <img src="assets/img/avatar-JohnDoe.jpg" alt="" class="img-d img-fluid">
                    </div>
